<?php
/**
 * Archive Document Handler - Administrative Staff
 * Fetch document details for viewing archived documents
 */
session_start();
...
$sql = "SELECT 
    ...
    WHERE da.id = ? AND da.assigned_by = ? AND da.status = 'Archived' LIMIT 1";
