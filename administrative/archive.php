<?php
/**
 * Archive Documents Page - Administrative Staff
...
// Fetch archived document assignments
$archived_documents = [];
$sql = "SELECT 
...
<body>
                ...
                <div class="table-container">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="8" class="empty-state">No archived documents</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
    ...
    <script>
        function viewArchivedDocument(assignmentId) {
            ...
            fetch('archive-handler.php?action=view&id=' + assignmentId)
                ...
                .then(data => {
                    if (data.success && data.assignment) {
                        ...
                        document.getElementById('viewArchivedAt').textContent = assignment.archived_at ? new Date(assignment.archived_at).toLocaleString() : '-';
