            ...
            fetch('outgoing-handler.php?action=view&id=' + assignmentId)
                ...
                .then(data => {
                    if (data.success && data.assignment) {
                        ...
                        document.getElementById('viewRecipient').textContent = (assignment.recipient_first_name || '') + ' ' + (assignment.recipient_last_name || '') || '-';
                        document.getElementById('viewDepartment').textContent = assignment.office_department || '-';
                        document.getElementById('viewDateSent').textContent = assignment.assigned_at ? new Date(assignment.assigned_at).toLocaleString() : '-';
