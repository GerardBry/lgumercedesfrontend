<?php
/**
 * Returned Document Handler - Regular User
 * Fetch document details for returned assignments for the assigner (department staff)
 */
session_start();
...
// Block Administrative Assistant and Super Admin from this endpoint
if (isset($_SESSION['role']) && ($_SESSION['role'] === 'Administrative Assistant' || $_SESSION['role'] === 'Super Admin')) {
...
// Fetch assignment details - verify user is the assigner
$sql = "SELECT 
        da.id,
        da.document_id,
        da.assigned_by,
    ...
    WHERE da.id = ? AND da.assigned_by = ? AND da.status = 'Returned' LIMIT 1";
